...
<head>
    <meta charset="UTF-8">
    <title style="alignment: center">distance</title>
    <style >
    </style>
...
<div class="main-wrapper">
    ...
    <div class="slider-container">
        <ul class="slider">
            <li class="slider-image" style="background-image:url('image/verde/verde07.jpg');">
        ...
        <div class="slider-content">
            ...
            <div class='tableauPlaceholder' style='width: 1000px; height: 700px;margin-left: 40px'>
                <object class='tableauViz' width='1000' height='700' style='display:none;'>
                    ...
                    <param name='name' value='UMD01&#47;Dashboard3' /><param name='tabs' value='no' />
