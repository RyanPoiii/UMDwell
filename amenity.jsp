...
<div class="main-wrapper">
    ...
    <div class="slider-container">
        <ul class="slider">
            <li class="slider-image" style="background-image:url('image/wallpaper/12.jpg');">
        ...
        <div class="slider-content">
            ...
            <div class='tableauPlaceholder' style='width: 1020px; height: 827px;margin-left: 30px '>
                <object class='tableauViz' width='1020' height='827' style='display:none;'>
                    ...
                    <param name='name' value='UMD01&#47;Dashboard2' /><param name='tabs' value='no' />
